...
- ユーザータイプ(company)を選択する
- Company の色が muted であることを確認する
- アコーディオンが閉じていることを確認する
- 商品セレクトボックスが表示されていることを確認する
- アコーディオンを開く
- アコーディオンが開いていることを確認する
...
- 商品(flower)を選択する
- 商品画像(flower)が表示されていることを確認する
- 商品(car)を選択する
- 商品画像(car)が表示されていることを確認する
